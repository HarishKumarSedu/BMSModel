...
class UsbBridge:
    ...
    def init(self, speed_idx: int):
        ...
        self.usb_bridge.GPIO_Init()
        self.usb_bridge.GPIO_0_OutputMode()
        self.usb_bridge.GPIO_1_InputMode()
        self.usb_bridge.GPIO_2_OutputMode()
        self.usb_bridge.GPIO_3_InputMode()
    ...
    def LTC4231Enable(self):
        self.usb_bridge.GPIO_0_OutputMode(1)
    
    def LTC4231Disable(self):
        self.usb_bridge.GPIO_0_OutputMode(0)
        
    def RelayEnable(self):
        self.usb_bridge.GPIO_1_OutputMode(1)
    
    def RelayDisable(self):
        self.usb_bridge.GPIO_1_OutputMode(0)
        
    def LM5170Enable(self):
        self.usb_bridge.GPIO_2_OutputMode(1)
    
    def LM5170Disable(self):
        self.usb_bridge.GPIO_2_OutputMode(0)
        
    def LM5170EnableBuck(self):
        self.usb_bridge.GPIO_3_OutputMode(1)
    
    def LM5170EnableBoost(self):
        self.usb_bridge.GPIO_3_OutputMode(0)
